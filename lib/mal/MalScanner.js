...
class MalScanner extends MalBaseScanner {
  ...
  static get allTasksFuncs() {
    return {
      ...
      test1: ['grabTest'],
      SpUserLogins_Lost: ['grabLostUserLogins', 'All'], //obsolete
      SpUserLogins_Re: ['grabLostUserLogins', 'Re'],
    };
  }
  ...
  /**
   * mode - 'All' to check user logins by "holes"-ids, 
   *  "Re" - regrab user logins with ids in redis' set "mal.recheckUserIds"
   */
  grabLostUserLogins(data, mode = 'All') {
